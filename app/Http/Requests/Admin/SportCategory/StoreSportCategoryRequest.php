...
namespace App\Http\Requests\Admin\SportCategory;
...
class StoreSportCategoryRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'uz.name.unique'   => 'Bu nom oldin tanlangan!',
            'ru.name.unique'   => 'Bu nom oldin tanlangan!',
            'en.name.unique'   => 'Bu nom oldin tanlangan!',
