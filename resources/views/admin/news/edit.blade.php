                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="form-group ">
                                    ...
                                    <select name="continent_id" class="form-control select2 select2-hidden-accessible" id="">
                                        <option value="europe" {{ old('europe', $item->continent_id) == 'europe' ? 'selected' : '' }}> Europe </option>
                                        <option value="asia" {{ old('asia', $item->continent_id) == 'asia' ? 'selected' : '' }}> Asia </option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12">
                                ...
                                @foreach ($images as $img)
                                    <img src="{{ asset("/admin/images/news/".$img) }}" width="100%"> <hr>
                                @endforeach
                            </div>
                        </div>
